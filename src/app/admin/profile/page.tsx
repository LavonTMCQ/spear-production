        ...
        <div className="flex-1">
          <Tabs defaultValue="account">
            ...
            <TabsContent value="account" className="space-y-4 mt-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Your administrative access levels
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Separator />
                    <div>
                      <h4 className="font-medium">Yesterday, 8:15 PM</h4>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <Separator />
                    <div>
                      <h4 className="font-medium">April 22, 2023, 3:45 PM</h4>
                      <p className="text-sm text-muted-foreground">
                        Firefox on Ubuntu • 192.168.1.10
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notify when users change subscription plans
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notify about system issues and outages
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
            ...
            <TabsContent value="appearance" className="space-y-4 mt-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Admin Dashboard Layout</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium">Analytics Widgets</h4>
                      <p className="text-sm text-muted-foreground">
                        Show analytics widgets on the dashboard
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
